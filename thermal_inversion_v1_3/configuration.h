...
#define SEND_INTERVAL           900000       // Tiempo de espera entre mensajes SI NO SE HABILITA EL VSI
...
#define VBAT_PIN        13                  // Pin al que conecto la batería para medir su voltaje
